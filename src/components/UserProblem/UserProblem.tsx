...
export const UserProblem = () => {
  ...
  bg-[radial-gradient(circle_at_70%_30%,rgba(34,229,138,0.08)_0%,rgba(34,229,138,0.04)_25%,rgba(11,15,14,0.95)_60%,#0B0F0E_100%)]'>
            ...
            >
                ...
                <h2 className='text-2xl sm:text-4xl xl:text-5xl uppercase font-black max-w-3xl font-bold'>You’re Not Stuck. You're Just<span className="text-primary/90 text-glow"> Unstructured. </span></h2>
