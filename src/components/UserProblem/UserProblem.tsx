    ...
    return (
        <section className='relative py-16 lg:py-32 overflow-hidden'>
            ...
            <header className='space-y-4 text-center sm:text-start px-6 md:px-12 lg:px-20 font-heading'>
                ...
                <h2 className='text-3xl sm:text-4xl uppercase font-bold max-w-3xl'>You’re Not Stuck. You’re Just<span className="font-black text-primary/90"> Unstructured. </span></h2>
